...
RETURN = r"""
agent_alias:
    description: A dictionary or list of dictionaries list of dictionaries, where each dictionary contains the detailed configuration of an agent alias.
    type: complex
    returned: always
    contains:
        agent_alias_id:
...
def main():
    ...
    try:
        ...
        aliases_details: List[Dict[str, Any]] = []

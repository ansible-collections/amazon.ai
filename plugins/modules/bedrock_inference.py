...
completion:
    ...
    type: str
    returned: success
    sample: "The key to a good cup of coffee is starting with freshly roasted beans and grinding them just before brewing. The water temperature should be between 195-205 degrees Fahrenheit (90-96 degrees Celsius), and the ratio of coffee to water is crucial. Experimenting with different brewing methods and personal taste is part of the fun!"
model_id:

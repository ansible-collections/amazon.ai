.. _amazon.ai.bedrock_agent_alias_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the agent alias.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>A list of dictionaries, where each dictionary contains the detailed configuration of an agent alias.</div>
                    <br/>
                </td>
            </tr>
                                <tr>

.. _amazon.ai.bedrock_agent_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>SUPERVISOR</li>
                                    <li>SUPERVISOR_ROUTER</li>
                                    <li>DISABLED</li>
                        </ul>
                </td>
                <td>
                        <div>The agent&#x27;s collaboration role.</div>
                </td>
            </tr>
            <tr>
                <td colspan="4">
                ...
                <td>
                        <div>Specifies a new name for the agent.</div>
                </td>
            </tr>
            <tr>
                <td colspan="4">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>agent_resource_role_arn</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>The ARN of the IAM role for the agent.</div>
            ...
            <tr>
                ...
                <td>
                        <div>ARN or name of a Bedrock model.</div>
                        <div>Required when O(state=present).</div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                        <div>The instructions for the agent.</div>
                        <div>Required when O(state=present).</div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                        <div>The new name to assign to the agent.</div>
                </td>
            </tr>
            <tr>
                <td colspan="4">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>orchestration_type</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    ...
                                    <li>CUSTOM_ORCHESTRATION</li>
                        </ul>
                </td>
                <td>
                        <div>Specifies the type of orchestration strategy for the agent.</div>
                </td>
            </tr>
            <tr>
                <td colspan="4">
            ...
            <tr>
                <td colspan="4">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>prompt_override_configuration</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                    </div>
                ...
                <td>
                        <div>A dictionary to define custom prompt configurations for the agent.</div>
                        <div>Supports fields to customize prompts at various stages of the agent&#x27;s processing.</div>
                </td>
            </tr>
                                <tr>
                ...
                <td>
                        <div>ARN of a Lambda function to override the prompt orchestration for the agent.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>A list of prompt configuration dictionaries.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>The prompt template to replace the default prompt template.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Inference parameters to use when invoking a foundation model.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>List of strings that signal the end of generation.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Sampling temperature for generation.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Top-K sampling parameter.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Top-P (nucleus) sampling parameter.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Specifies whether to override the default parser.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Specifies whether to override the default prompt template.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Specifies whether to allow the agent to carry out the step specified in the prompt type.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Step in the agent sequence that this prompt configuration applies to.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>The state of the agent.</div>
                </td>
            </tr>
            <tr>
                <td colspan="4">
                ...
                <td>
                        <div>Any tags that you want to attach to the agent.</div>
                        <div>Tags cannot be modified. They are only applied when a new Amazon Bedrock Agent is created.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Specifies the maximum amount of time, in seconds, that the module should wait for the requested operation on the Bedrock Agent to complete before timing out.</div>
                        <div>This applies to operations that may take time to reach a stable state, such as creating, or updating an agent.</div>
                        <div>During this period, the module will poll the agent&#x27;s status at regular intervals to detect when the operation has completed.</div>
                        <div>If the agent does not reach the desired state within this timeout, the module will fail.</div>
                        <div>Increasing this value may be useful for slower or heavily loaded environments, while decreasing it can make the module fail faster when quick feedback is desired.</div>
                </td>
            </tr>
    </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>A dictionary containing the detailed configuration of the managed Bedrock agent.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>The Amazon Resource Name (ARN) of the agent.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:bedrock:us-east-1:123456789901:agent/RNKFFDOKFN</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The unique identifier of the agent.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">test-bedrock-agent-test</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>The ARN of the IAM role with permissions to invoke the agent.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:iam::123456789901:role/test-bedrock-agent-role-7a58c95cf105</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>The current status of the agent.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The timestamp when the agent was created.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The foundation model used for orchestration by the agent.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">amazon.nova-micro-v1:0</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>idle_session_ttl_in_seconds</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                    </div>
                ...
                <td></td>
                <td>
                            <div>The number of seconds for which the agent keeps conversation information.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The instructions that tell the agent what it should do.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">You are a friendly chat bot that provides helpful information and assistance to users.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>The orchestration strategy for the agent.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The timestamp when the agent was last prepared.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2025-10-01T15:36:47.859575+00:00</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>Contains configurations to override prompt templates in different parts of an agent sequence.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>Inference parameters to use when the agent invokes a foundation model.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>Specifies whether to override the default parser Lambda function.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                            <div>Specifies whether to override the default prompt template for this prompt type.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The step in the agent sequence that this prompt configuration applies to.</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The timestamp when the agent was last updated.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">Agent &#x27;test-bedrock-agent-7a58c95cf105&#x27; created successfully.</div>
                </td>
            </tr>
    </table>
    <br/><br/>

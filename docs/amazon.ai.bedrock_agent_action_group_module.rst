.. _amazon.ai.bedrock_agent_action_group_module:
...
**Manage Amazon Bedrock Agent Action Groups**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the action group.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>action_group_state</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>Specifies whether the action group is available for the agent to invoke or not when sending an InvokeAgent request.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The version of the agent.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>A description of the action group.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The ARN of the Lambda function for the action group.</div>
                        <div>Required when O(state=present).</div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                        <div>Specifies a new name for the action group.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The state of the action group.</div>
                        <div>To delete an action group, ensure that the O(action_group_state=DISABLED).</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>A dictionary containing the detailed configuration of an action group.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>Details about the action group&#x27;s executor.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>The ARN of the Lambda function that executes the action group.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:lambda:us-east-1:123456789012:function:test-bedrock-lambda-test:12</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The unique identifier of the action group.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">9IXXEEO8FR</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">get-weather-info-test</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The unique identifier of the agent this action group belongs to.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The version of the agent this action group is associated with.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The OpenAPI 3.0 schema that defines the action group&#x27;s API.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>The raw YAML/JSON content of the API schema.</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>The timestamp when the action group was created.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">Gets the current date and time.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>The timestamp when the action group was last updated.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2025-10-03T14:33:09.676524+00:00</div>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">Action group &#x27;get_weather_info_8e57bb73f58e&#x27; created successfully.</div>
                </td>
            </tr>
    </table>
    <br/><br/>

    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>A list of dictionaries, where each dictionary contains detailed configuration of a Bedrock AgentCore runtime endpoint.</div>
                            <div>When a specific endpoint is requested, returns a single-element list.</div>
                    <br/>
                </td>
            </tr>
                                <tr>

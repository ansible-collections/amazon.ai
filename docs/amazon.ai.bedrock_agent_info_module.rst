.. _amazon.ai.bedrock_agent_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The unique identifier of the agent to retrieve. If not provided, the module will list all agents.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <b>Default:</b><br/><div style="color: blue">"DRAFT"</div>
                </td>
                <td>
                        <div>Agent&#x27;s version.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>If V(true), lists all action groups for the specified agent.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>If V(true), lists all aliases for the specified agent.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>A list of dictionaries, where each dictionary contains detailed configuration of the managed Bedrock agent.</div>
                    <br/>
                </td>
            </tr>
                                <tr>

.. _amazon.ai.sagemaker_endpoint_module:
...
**Manage Amazon SageMaker endpoints**
...
- The referenced endpoint configuration is managed separately with :ref:`amazon.ai.sagemaker_endpoint_config <amazon.ai.sagemaker_endpoint_config_module>`.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the endpoint configuration the endpoint serves.</div>
                        <div>Required when O(state=present).</div>
                        <div>Changing it on an existing endpoint updates the endpoint in place.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Whether to remove tags not specified in O(tags).</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The desired state of the endpoint.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Tags to associate with the endpoint.</div>
...
.. note::
   - Required IAM actions include sagemaker:CreateEndpoint, sagemaker:DescribeEndpoint, sagemaker:UpdateEndpoint, sagemaker:DeleteEndpoint, sagemaker:ListEndpoints, sagemaker:AddTags, sagemaker:ListTags, and sagemaker:DeleteTags.
...
.. seealso::
   ...
   :ref:`amazon.ai.sagemaker_endpoint_info_module`
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>The endpoint after the operation.</div>
                    <br/>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">Endpoint my-endpoint created successfully.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">

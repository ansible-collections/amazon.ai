.. _amazon.ai.devopsguru_resource_collection_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>AWS_CLOUD_FORMATION</li>
                                    <li>AWS_SERVICE</li>
                                    <li>AWS_TAGS</li>
                        </ul>
                </td>
                <td>
                        <div>The type of Amazon Web Services resource collections to return.</div>
                        <div>The one valid value is V(CLOUD_FORMATION) for Amazon Web Services CloudFormation stacks.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Information about the DevOps Guru resource collection of the specified type.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>Details about AWS CloudFormation stacks in the resource collection.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>List of CloudFormation stack names included.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;app-stack&#x27;, &#x27;database-stack&#x27;]</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>Details about AWS services included in the resource collection.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>List of AWS service names included.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;ec2&#x27;, &#x27;rds&#x27;]</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>Details about resource tags included in the resource collection.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>The key used to identify a set of AWS resources based on tags.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">env</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>List of tag values defining the resource collection.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;production&#x27;, &#x27;staging&#x27;]</div>
                </td>
            </tr>
